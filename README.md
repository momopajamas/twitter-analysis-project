...
# Appendix 
### Navigation
- [Dataset from data.world](https://data.world/crowdflower/brands-and-product-emotions) **Note**: Accessing dataset may require sign in, otherwise the link may take you to a 404 error.
